...
var file_protos_nodes_nodes_proto_goTypes = []any{
...
func file_protos_nodes_nodes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_nodes_nodes_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_protos_nodes_nodes_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ISO); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protos_nodes_nodes_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_protos_nodes_nodes_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_protos_nodes_nodes_proto_msgTypes[4].Exporter = func(v any, i int) any {
